...
[`precarga-offline.md`](precarga-offline.md); el de los commits vacíos ya está
hecho ([`2026-08-20 commits-vacios.md`](../decisions/2026-08-20%20commits-vacios.md))
y el del orden errático del filtro se descartó:
[`../discarded/filtro-orden-erratico.md`](../discarded/filtro-orden-erratico.md).
